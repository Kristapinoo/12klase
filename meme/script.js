...
const optionInputElementObject = document.querySelector('.form-control')
...
let headerValue = ''
let footerValue = ''
const optionElement = document.querySelector('.form-control-options');
...
submitButton.addEventListener('click', () => {
  ...
  if (headerValue && footerValue) {
    ...
    const transformedOptionValue = optionValue.replaceAll(' ', '_')

    // uzģenerējam jauno memi
    const memeUrl = `https://urlme.me/${transformedOptionValue}/${transformedHeaderValue}/${transformedFooterValue}.jpg`
